...
//02780180018102820283018401850186018702880292
public class ClaveDePrevencion {

    public void claveDePrevencion(String cadena,int tam_Segmento,int tam_subseg,int tam_subsegSize){
