 ...
 */
public class ClaveDePrevecionPersonaRealacionada {

    public void claveDePrevencionPersonaRelacionada(String cadena,int tam_Segmento,int tam_subseg,int tam_subsegSize){
